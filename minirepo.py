...
PYTHON_VERSIONS = [
        ...
        'cp26', 'cp27', 'cp3', 'cp32', 'cp33', 'cp34', 'cp35', 'cp38', 'cp39', 'cp310', 
        'cp36', 'cp37', 'py2', 'py2.py3', 'py26', 'py27', 'py3', 
        'py3.5', 'py3.6', 'py3.7', 'py3.8', 'py3.9', 'py3.10', 'py32, py33, py34', 'py35', 'py36', 
        'py37', 'py38', 'py39', 'py310' 'source', 'any']
...
def get_config():
    ...
    try:
        ...
        newrepo = raw_input("Input Repository Folder: ")
        if newrepo:
            repository = newrepo
